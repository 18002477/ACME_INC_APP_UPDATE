...
namespace ACME_INC_APP.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(ACMEContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserRoleId,UserRole1")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserRoleId,UserRole1")] UserRole userRole)
        {
